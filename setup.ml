...
(* OASIS_START *)
(* DO NOT EDIT (digest: d0c9af1a62b2e14632b8952d2c5792e1) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          authors = ["tvolf"];
          homepage = None;
          synopsis = "benford's law test check";
          description = None;
          categories = [];
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("cp", ["_build/benford.native"; "./benford.exe\n"])))
                 ]
            };
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "benford.ml"})
            ];
          plugins =
            [
               (`Extra, "META", Some "0.4");
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "ue⁄\007â∂Â\020ÌWr\004Ã€Ê\029";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
